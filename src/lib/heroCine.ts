 ...
 *
 *   cities  (variante atmo)  0 → 1    corpo das luzes de cidade no lado noturno
 *   sunrise (variante dawn)  0 → 1    o sol sobe no limbo: sai de trás da Terra,
 *                                    o flare abre e o ponto de contacto incendeia
 *   drift   (variante dawn) -1 → 1    parallax lateral do sol/flare contra o limbo
 *
